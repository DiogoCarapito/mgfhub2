...
def preprocess(df):
    ...
    df_stack["Cumprimento"] = df_stack["Utentes Cumpridores"] / df_stack["Total Utentes"] * 100
    ...
    df_final = df_stack[["Indicador", "Medico Familia", "Cumprimento"]]
...
def etl_xlsx(file_xlsx):
    if file_xlsx is not None:
        ...
        file_xlsx = pd.read_excel("data/P02_01_R04_ Indicadores por lista de utentes de médico - cumpridores e não cumpridores.xlsx")
